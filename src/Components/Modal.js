...
function Modal({display, closeModal, Name, Discription}) {
  ...
  return (
      <>
        <div className="fixed z-10 inset-0 overflow-y-auto" aria-labelledby="modal-title" role="dialog" aria-modal="true" style = {display} >
